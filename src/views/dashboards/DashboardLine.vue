  ...
  <LayoutDefault v-if="dashboard" width="full" class="min-h-screen flex flex-col">
    ...
    <div class="flex-1 flex flex-col sm:flex-row">
      ...
      <nav class="min-w-[24rem] max-w-[24rem] border-r p-4">
        ...
        <div @click="toggleModal()" class="flex items-center justify-center border border-indigo-400 border-dashed rounded-lg mt-4 py-3 px-2 cursor-pointer hover:bg-indigo-50">
          <p class="text-sm text-indigo-600">Add a funnel</p>
        </div>
      </nav>
