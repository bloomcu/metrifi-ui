  ...
  <LayoutWithSidebar>
    ...
    <div v-if="recommendationStore.recommendations" class="flex flex-col gap-4 mb-20">
      <div
        ...
        @click="router.push({ name: 'recommendation', params: { organization: recommendation.organization.slug }})"
        ...
        <div class="flex flex-col space-y-4 w-full px-4 py-4">
          ...
          <div class="flex items-center justify-between border-b pb-4">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm text-gray-500 pr-3">Modified {{ moment(recommendation.updated_at).fromNow() }}</span>
          ...
          <div v-if="recommendation.status !== 'done'" class="mb-3">
