        ...
        <div class="flex flex-col space-y-4 w-full px-4 py-4">
          ...
          <div class="flex items-start justify-between border-b pb-4">
            ...
            <div class="flex items-center gap-2">
                ...
                <!-- Delete -->
                <button @click.stop="destroyRecommendation(recommendation)" class="cursor-pointer font-medium rounded-md p-1.5 text-sm text-gray-400 bg-white hover:bg-gray-200 ring-1 ring-inset ring-gray-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
