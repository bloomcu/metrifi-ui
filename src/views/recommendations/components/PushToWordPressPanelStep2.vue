<template>
  <h3 class="text-xl font-medium mb-4">Step 2 - Get block schemas</h3>
  ...
  <div class="flex items-center gap-2 mt-6">
    <AppButton @click="getAllBlockSchemas()" variant="secondary" size="base" class="flex items-center gap-2">
      Get block schemas
    </AppButton>
  </div>
...
const getSchema = (block) => {
  ...
  if (!matchingSchema) {
    block.error = 'No schema found';
  }
}

const getAllBlockSchemas = () => {
