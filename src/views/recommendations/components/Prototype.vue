          ...
          >
            ...
            <div v-else-if="block.html" class="relative">
                <div v-if="recommendationStore.recommendation.status === 'done'">
                    <button v-if="block.outline" @click.stop="regenerateBlock(block)" class="absolute z-[9999] top-2 right-2 bg-violet-600 hover:bg-violet-700 text-white px-3 py-1 rounded-md text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        Regenerate
                    </button>
