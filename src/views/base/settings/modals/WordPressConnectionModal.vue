      ...
      <form @submit.prevent="connectWordPress" class="mt-6">
        <div class="space-y-4">
          ...
          <template v-if="isValidUrl(wordpressForm.token.wordpress_url)">
            ...
            <div v-if="pluginStatus.installed === true" class="p-4 bg-[#EEFFF7] rounded-md text-sm">
              <div class="flex items-center">
                <div class="flex-shrink-0">
                  <svg class="h-8 w-8 text-[#99FFCC]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clip-rule="evenodd" />
                  </svg>
                </div>
                <div class="ml-3">
                  <h3 class="text-sm font-medium text-[#2B0F52]">MetriFi WP Plugin Detected</h3>
                </div>
              </div>
            </div>
