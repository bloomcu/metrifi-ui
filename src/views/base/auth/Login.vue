      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <p class="mt-3 leading-6 text-gray-500">
            ...
            <RouterLink :to="{ name: 'register' }" class="font-medium leading-6 text-violet-500 hover:text-violet-600">Register</RouterLink>
          </p>
        </div>
        ...
        <div class="mt-10">
          <form action="#" @submit.prevent="login()" class="w-full">
            ...
            <p class="mt-6 leading-6 text-gray-500">
              Forgot password?
              <RouterLink :to="{ name: 'forgotPassword' }" class="font-medium leading-6 text-violet-500 hover:text-violet-600">Reset password</RouterLink>
            </p>
          </form>
        </div>
      </div>
