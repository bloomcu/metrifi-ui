                  ...
                  <div class="flex flex-row items-center justify-between">
                    ...
                    <div class="flex items-center gap-1">
                        <AppTooltipWrapper v-if="metric.pageTitle">
                            ...
                            <AppTooltip alignment="left" text="Why isn't the Page Path included in this dimension? Page Path is shown in the dimension picker for reference only and does not affect the funnel results. If multiple entries have the same Page Title but different Page Paths, choosing any of them will yield the same result in your funnel." class="w-[350px]"/>
                        </AppTooltipWrapper>
