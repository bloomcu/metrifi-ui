        ...
        <div class="group relative flex items-start mb-6" aria-current="step">
          <span class="flex h-9 items-center" aria-hidden="true">
            <span class="relative z-10 flex h-8 w-8 items-center justify-center rounded-full border-2 border-violet-600 bg-white">
              <span class="relative z-10 flex h-8 w-8 items-center justify-center rounded-full bg-violet-500">
          ...
          <span class="ml-4 flex min-w-0 flex-col">
            <span class="text-sm font-medium text-violet-500">Running automation</span>
