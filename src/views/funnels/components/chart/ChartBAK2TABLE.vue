      ...
      <div v-if="funnel && funnel.report" class="flex flex-col gap-4">
          ...
          <div class="flex flex-col w-full">
              ...
              <div class="table w-full border-collapse">
                ...
                <div class="table-row">
                  <template v-for="(step, index) in funnel.report.steps" :key="step.id">
                    <div class="table-cell align-top px-1.5 py-1 border-b border-gray-200">
                ...
                <div class="table-row">
                  <template v-for="(step, index) in funnel.report.steps" :key="step.id">
                    <div class="table-cell align-top px-1.5 py-1 text-gray-700 border-b border-gray-200">
                ...
                <div class="table-row">
                  <template v-for="(step, index) in funnel.report.steps" :key="step.id">
                    <div class="table-cell align-top px-1.5 py-1 text-gray-700">
                      <AppTooltipWrapper>
