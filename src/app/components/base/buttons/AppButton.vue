...
const variantClasses = {
  primary: 'text-white bg-violet-600 hover:bg-violet-600 shadow-sm',
  secondary: 'text-violet-600 bg-violet-50 hover:bg-violet-100',
  ...
  link: 'text-violet-600 hover:text-violet-700 px-0',
}
</script>
